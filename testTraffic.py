...
if X.empty or y.empty:
    ...
    accuracy_percentage = r2_test * 100
    print(f'Random Forest Accuracy on Test Data (R²): {accuracy_percentage:.2f}%')
    ...
    # Print the actual traffic volume for comparison
    print("Actual Traffic Volume:")
    print(y_test.values)